null
###*
@class AP.view.component.Scatterplot
@extends AP.view.Chart

Renders a scatterplot chart using data from the specified query scope.
###
class AP.view.component.Scatterplot extends AP.view.Chart
  className: 'ap-chart ap-scatterplot'
  chartType: 'scatter'
  ...
  renderChart: ->
    ...
    nv.addGraph =>
      ...
      @chart.xAxis.axisLabel(series.independentVariable)
