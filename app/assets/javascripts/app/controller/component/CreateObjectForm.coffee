null
###*
@class AP.controller.component.CreateObjectForm
@extends AP.controller.Controller

Handles interactions with object creation forms.

See `AP.view.component.CreateObjectForm`.
###
class AP.controller.component.CreateObjectForm extends AP.controller.Controller
  ###*
  @inheritdoc
  ###
  events: [
    ['.ap-createobjectformpage', 'savesuccess', 'onSaveSuccess']
    ['.ap-createobjectformpage', 'savefailure', 'onSaveFailure']
    ['.ap-createobjectformpage', 'validationfailure', 'onValidationFailure']
  ]
